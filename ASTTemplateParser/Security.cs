...
namespace ASTTemplateParser
{
    ...
    public sealed class SecurityConfig
    {
        ...
        /// <summary>
        /// Whether to encode JavaScript special characters (default: true)
        /// </summary>
        public bool JavaScriptEncode { get; set; } = true;
        ...
        /// <summary>
        /// Use strict whitelist mode for expressions (default: true)
        /// Only allows explicitly whitelisted operators and functions
        /// </summary>
        public bool StrictExpressionMode { get; set; } = true;
        ...
        /// <summary>
        /// Whether to allow indexer access like array[0] (default: false)
        /// </summary>
        public bool AllowIndexerAccess { get; set; } = false;
    ...
    public static class SecurityUtils
    {
        ...
        public static string HtmlEncode(object value, SecurityConfig config = null)
        {
            ...
            // Additional JavaScript encoding if enabled
